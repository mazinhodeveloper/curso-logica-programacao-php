...
<div class="mt-4">
    ...
    <table id="table_conta" class="table table-striped">
        ...
        class PagamentosRepositorio {
            ...
            public function listarEmAberto($dataInicial = null, $dataFinal = null) {
                   $sql = "SELECT
                        p.id_pagamento,
                        p.data_vcto,
                        p.valor,
                    ...
                    WHERE valor_pago = 0 AND oculto = 0";
 
                    if ($dataInicial && $dataFinal) {
                        $sql .=" AND data_vcto BETWEEN :data_incial AND :data_final";
            ...
            $repo= new PagamentosRepositorio($pdo);
            $aberto = $repo->listarEmAberto(
                $pagamento->getDatainicial(),
                $pagamento->getDataFinal()
            );
            ?>
            <?php
